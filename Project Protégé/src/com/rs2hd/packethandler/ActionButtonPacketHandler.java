...
public class ActionButtonPacketHandler implements PacketHandler {
	...
	public void handlePacket(Player player, IoSession session, Packet packet) {
		 ...
		 */
		case 105:
			World.getInstance().getGrandExchangeManager().handleButton(player, interfaceId, buttonId, buttonId2);
			break;
		/*
		 * Trade first screen.
		 */
		case 335:
			...
			case 32:
				...
				if(packet.getId() == 90) {
					player.getRequests().getTrade().examineOther(player, buttonId2);
				}
				break;
			}
			break;
		...
		case 336:
			...
			case 214:
				...
				break;
			case 173:
				player.getRequests().getTrade().offerItem(player, buttonId2, 1); // TODO Option X
				break;
			case 133:
				// TODO lend
				break;
		...
		case 387:
			...
			switch(buttonId) {
			case 55:
				player.getActionSender().sendInterface(667, false);
		...
		case 261:
			...
			case 14:
				 ...
				 * Settings screen.
				 */
				player.getActionSender().sendInterface(742, false);
				break;
			case 16:
				/*
				 * Settings screen.
				 */
				player.getActionSender().sendInterface(743, false);
				break;
			case 2:
				/*
				 * Chat effects config.
